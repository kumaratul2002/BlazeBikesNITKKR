...
import loginimg from "../assets/LB.png"
function Login() {
  ...
  return (
      ...
      >
        ...
        >
          <Grid xs={12} sm={12} md={6} lg={6}>
            <img
              src="https://i.postimg.cc/nL0dvmBg/LB.png"
    ...
    <img src={logo} style={{width:'12%',marginTop:'3%',marginRight:'5%' }}></img>
            ...
            >
              ...
              <br />
              <Typography>Don't have a account? <Link to="/register">Register Here</Link></Typography>
